...
[![CRAN RStudio mirror
downloads](http://cranlogs.r-pkg.org/badges/opencv)](http://cran.r-project.org/web/packages/opencv/index.md)
...
[`opencv-devel`](https://src.fedoraproject.org/rpms/opencv):
